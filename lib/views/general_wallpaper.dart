...
class GeneralWallpaper extends StatefulWidget {
  @override
  _GeneralWallpaperState createState() => _GeneralWallpaperState();
}

class _GeneralWallpaperState extends State<GeneralWallpaper>
  ...
  Future<void> _fetchImages() async {
    ...
    try {
      final result =
          await _imageController.fetchImageUrls('general', page: _currentPage);
      setState(() {
